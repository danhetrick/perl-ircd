...
* _**Configurable**_ - Run **Raven IRCd** with the [default settings](#default-settings), or [configure](#configuration) to your heart's content!  Configuration files are written in [easy-to-read XML-like](#configuration-file-format) language, *Raven XML*.
